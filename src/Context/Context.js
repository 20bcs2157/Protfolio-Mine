...
import tictactoe from '../assets/ProductImages/tictactoe.png';
import Boxoffice from '../assets/ProductImages/Boxoffice.png';
import Chat from '../assets/ProductImages/Chat.png';
  ...
  projects: [
    {
      ...
      img: Chat,
      description: `chat application makes it easy to communicate with people anywhere in the world by sending and receiving messages in real time. where we can create chat-room and sen easily files,image and voice.`,
      url: 'https://chat-web-app-ca650.web.app/signin',
    },
    {
      title: 'Box-office',
      img: Boxoffice,
      description: `Box-office is movie and actor detail platform. where we can serach any movie or serach actors details like age , live or more. `,
      url: 'https://20bcs2157.github.io/box-office/#/',
    },
    {
      title: 'tic-tac-toe',
      img: tictactoe,
      description: `Tic-tac-toe, is a paper-and-pencil game for two players who take turns marking the spaces in a three-by-three grid with X or O. The player who succeeds in placing three of their marks in a horizontal, vertical, or diagonal row is the winner`,
      url: 'http://tic-tac-toegame.surge.sh/',
    },
    // {
